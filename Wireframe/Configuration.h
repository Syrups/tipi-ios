...
#define kApiRootUrl @"http://localhost:3000/api/v1"
#define kMediaRootUrl @"http://localhost:3000/uploads/media/"
#define kAudioRootUrl @"http://localhost:3000/uploads/audio/"
